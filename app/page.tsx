  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-100">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        {/* === 第一部分：區間表現分析 (Separated Layout) === */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
          
          {/* 左側：控制面板 */}
          <section className="lg:col-span-4 h-fit bg-white rounded-2xl shadow-sm border border-slate-200 p-6 flex flex-col gap-6">
            ...
            <div>
              ...
              <div className="custom-scrollbar max-h-[240px] overflow-y-auto rounded-lg border border-slate-200 bg-slate-50 p-3 shadow-inner">
                {factors.map((f) => (
